    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
      ...
      {products.length === 0 ? (
        <div className="max-w-md mx-auto text-center space-y-6 py-12">
          ...
          <h2 className="font-sans text-2xl font-bold uppercase tracking-wider">Wishlist is Empty</h2>
          ...
          {products.map((prod) => (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                <div>
                  <h3 className="font-sans text-xs font-semibold text-luxury-dark leading-snug line-clamp-1">
                    {prod.name}
                  </h3>
