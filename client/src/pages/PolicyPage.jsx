  ...
  if (type === 'privacy') {
    ...
    content = (
      <div className="space-y-6 text-xs text-luxury-textGray leading-relaxed">
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">1. Information We Collect</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">2. Payment Security</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">3. Cookie Policies</h3>
    ...
    content = (
      <div className="space-y-6 text-xs text-luxury-textGray leading-relaxed">
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">1. Orders & Pricing</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">2. Verification Calls</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">3. Copyrights & Designs</h3>
    ...
    content = (
      <div className="space-y-6 text-xs text-luxury-textGray leading-relaxed">
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">1. 7-Day Exchange Window</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">2. Non-Refundable/Custom Articles</h3>
        ...
        <h3 className="font-sans font-bold text-sm text-luxury-dark uppercase tracking-wider">3. How to Request Return</h3>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-sans font-bold uppercase tracking-wider">{title}</h1>
